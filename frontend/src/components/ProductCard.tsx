...
export function ProductCard({ product, onClick, variant = 'grid' }: ProductCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full bg-gradient-to-br from-amber-100 via-orange-100 to-red-100 dark:from-amber-900 dark:via-orange-900 dark:to-red-900 overflow-hidden flex-shrink-0" style={{ aspectRatio: '1 / 1' }}>
        <motion.div
          whileHover={{ scale: 1.1 }}
