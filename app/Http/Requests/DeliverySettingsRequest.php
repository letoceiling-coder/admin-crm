...
class DeliverySettingsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'delivery_type' => ['required', 'in:fixed,zones'],
            'fixed_delivery_cost' => ['required_if:delivery_type,fixed', 'nullable', 'numeric', 'min:0'],
            'delivery_zones' => ['required_if:delivery_type,zones', 'nullable', 'array'],
    ...
    public function messages(): array
    {
        return [
            ...
            'delivery_type.in' => 'Тип доставки должен быть "fixed" или "zones"',
            'fixed_delivery_cost.required_if' => 'Фиксированная стоимость доставки обязательна при выборе типа "Фиксированная доставка"',
            'fixed_delivery_cost.numeric' => 'Фиксированная стоимость доставки должна быть числом',
            'fixed_delivery_cost.min' => 'Фиксированная стоимость доставки не может быть отрицательной',
            'delivery_zones.required_if' => 'Зоны доставки обязательны при выборе типа "Зоны доставки"',
